...
def main():
    ...
    while True:
        ...
        # TODO: Faça a verificação para saber quantos números positivos e negativos
...
if __name__ == "__main__":
    ...
    permite que você defina um comportamento específico quando o script é executado 
    diretamente, mas também permite que o mesmo script seja importado e reutilizado
    em outros scripts. 
    """